...
class OrderitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orderitem" do
    assert_difference('Orderitem.count') do
      post orderitems_url, params: { orderitem: { description: @orderitem.description, name: @orderitem.name, quantity: @orderitem.quantity, total: @orderitem.total, unit: @orderitem.unit } }
    end
  ...
  test "should update orderitem" do
    patch orderitem_url(@orderitem), params: { orderitem: { description: @orderitem.description, name: @orderitem.name, quantity: @orderitem.quantity, total: @orderitem.total, unit: @orderitem.unit } }
